	...
	return (
		<div className={styles.page}>
			...
			<section className={styles.section__three}>
				<div className="container">
					<span>Наша цель - создать фантастический <br />
					сервис для всех потребителей</span>
					<div className={styles.section__three_columns}>
						<div>
							<h3>5</h3>
							<span>Lorem ipsum dolor sit amet consectetur. Rhoncus risus nunc a pharetra viverra enim nunc.</span>
						</div>
						<div>
							<h3>30</h3>
							<span>Gravida vel convallis id aliquet volutpat nullam dignissim. Amet parturient elementum lectus rhoncus at.</span>
						</div>
						<div>
							<h3>300</h3>
							<span>Sed varius ut venenatis id amet et consectetur pellentesque. Vitae urna ornare vel suspendisse tincidunt. </span>
						</div>
						<div>
							<h3>8</h3>
							<span>Id enim ornare lacus duis. Ac fermentum auctor cras adipiscing feugiat quis convallis velit. </span>
						</div>
					</div>
					<div className={styles.section__three_block} style={{ backgroundImage: `url(${patternImage.src})` }}>
						<div className={styles.section__three_block_title}>
							<h3>
								<span>Экономьте</span> свое время и получайте <span>максимум</span> от ежедневных покупок
							</h3>
							<div>
								<Image src={googlePlayImage.src} alt="google play store" width={164} height={51} />
								<Image src={appStore.src} alt="app store" width={164} height={51} />
							</div>
						</div>
						<div className={styles.section__three_block_image}>
							<Image src={iphoneOne.src} alt="Iphone one" width={295} height={598} style={{ objectFit: 'contain' }} />
							<Image src={iphoneTwo.src} alt="Iphone two" width={295} height={598} style={{ objectFit: 'contain' }} />
						</div>
					</div>
				</div>
			</section>
